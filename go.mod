...
replace (
	google.golang.org/genproto => google.golang.org/genproto v0.0.0-20260918162117-cecb64721679
	google.golang.org/genproto/googleapis/rpc => google.golang.org/genproto/googleapis/rpc v0.0.0-20260918162117-cecb64721679
)
